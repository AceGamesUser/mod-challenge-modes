...
public:
    ...
    void OnPlayerLogin(Player* player) override
    {
        ...
        player->KillPlayer();
        player->GetSession()->KickPlayer(std::string("Your hardcore character has died and cannot be revived."));
    }
...
public:
    ...
    bool OnGossipHello(Player* player, GameObject* go) override
    {
        ...
        {
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Enable Slow XP Gain", 0, SETTING_SLOW_XP_GAIN);
        }
        ...
        {
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Enable Very Slow XP Gain", 0, SETTING_VERY_SLOW_XP_GAIN);
        }
        if (sChallengeModes->challengeEnabled(SETTING_QUEST_XP_ONLY) && !playerSettingEnabled(player, SETTING_QUEST_XP_ONLY))
        {
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Enable Quest XP Only", 0, SETTING_QUEST_XP_ONLY);
        }
